...
class Drawing:
    ...
    def mini_map(self, player):
        ...
        pygame.draw.line(self.sc_map, GREEN, (map_x, map_y), (map_x + 60 * math.cos(player.angle),
                                                 map_y + 1000 * math.sin(player.angle)), 2)
    ...
    def win(self):
        ...
        self.sc.blit(render, (rect.centerx - 430, rect.centery - 1140))
        pygame.display.flip()
        self.clock.tick(15)
    ...
    def menu(self):
        ...
        start = button_font.render('СТАРТ', 1, pygame.Color('lightgray'))
        ...
        while self.menu_trigger:
            ...
            self.sc.blit(exit, (button_exit.centerx - 150, button_exit.centery - 70))

            color = randrange(1)
            label = label_font.render('GAMEPY', 5, (color, color, color))
