...
class Sprites:
    def __init__(self):
        ...
        self.list_of_objects = [
            ...
            SpriteObject(self.sprite_parameters['npc_devil'], (16, 8)),
            SpriteObject(self.sprite_parameters['npc_devil'], (8, 16)),
            SpriteObject(self.sprite_parameters['npc_devil'], (20, 4)),
            SpriteObject(self.sprite_parameters['npc_devil'], (4, 15)),
            SpriteObject(self.sprite_parameters['npc_devil'], (8, 25)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (8.6, 5.6)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (11.6, 4.6)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (13.6, 6.6)),
            SpriteObject(self.sprite_parameters['sprite_flame'], (2.6, 9.6)),
            SpriteObject(self.sprite_parameters['sprite_door_v'], (3.5, 3.5)),
            SpriteObject(self.sprite_parameters['sprite_door_h'], (1.5, 4.5)),
            SpriteObject(self.sprite_parameters['sprite_door_v'], (9.5, 11.5)),
            SpriteObject(self.sprite_parameters['sprite_door_h'], (20.5, 20.5)),
            ...
            SpriteObject(self.sprite_parameters['npc_soldier0'], (9.61, 2.92)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (1.68, 1.47)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (6.75, 3.65)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (2.27, 11.5)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (3.26, 8.29)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (2.5, 1.5)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (51.51, 1.5)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (6.61, 2.92)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (29.68, 12.47)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (8.75, 3.65)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (1.27, 11.5)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (1.6, 25.)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (9.61, 2.92)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (9.6, 1.47)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (6.75, 7.65)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (2.27, 12.5)),
            SpriteObject(self.sprite_parameters['npc_soldier0'], (2.26, 8.29)),
        ]
